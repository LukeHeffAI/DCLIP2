...
def generate_prompt(model, category_name: str):
    # you can replace the examples with whatever you want; these were random and worked, could be improved
    if model == "gpt3.5-turbo-instruct":
...
def obtain_descriptors_and_save(filename, class_list):
    ...
    prompts = [generate_prompt(model='gpt3.5-turbo-instruct', category_name=category.replace('_', ' ')) for category in class_list]
