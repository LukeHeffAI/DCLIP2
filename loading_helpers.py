    ...
    if hparams['category_name_inclusion'] is not None:
        ...
        for i, (k, v) in enumerate(gpt_descriptions.items()):
            ...
            if (hparams['category_name_inclusion'] == 'append'):
                ...
                # Base structure, with ImageNet subcategory. Best (63.32% (_best)): "tench, which is a freshwater fish, which is a type of freshwater fish"
                # Base structure, with ImageNetv2 subcategory. Best (56.31%): "tench, which is a freshwater fish, which is a type of freshwater fish"
