...
def make_descriptor_sentence(class_name, descriptor, subcategory, hparams): # TODO: replace word_to_add, item, subcategory_to_add with class_name, descriptor, subcategory
    if hparams['method'] == 'clip':
        ...
        # Best (45.88%): "banded, which is a repeating pattern of light and dark bands, which is described as a {subcategory} texture"
    ...
    return build_descriptor_string
